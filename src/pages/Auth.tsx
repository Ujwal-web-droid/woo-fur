...
import { Mail, Lock, User, Sparkles, Heart, ArrowLeft } from 'lucide-react';
...
export default function Auth() {
  ...
  const { signIn, signUp, signInWithMagicLink, signInWithGoogle, isAuthenticated, isLoading: authLoading } = useAuth();
  ...
  const handleResetPassword = async (data: ResetPasswordFormData) => {
    ...
    // Use magic link for password reset
    const { error } = await signInWithMagicLink(data.email);
        ...
        <Card className="border-border/50 shadow-elevated">
          <CardHeader className="text-center space-y-2">
            ...
            <CardTitle className="text-2xl font-bold">
              {showMagicLink ? 'Magic Link Sign In' : showResetPassword ? 'Reset Password' : 'Welcome to Woo-Fur'}
            </CardTitle>
            <CardDescription>
              {showMagicLink 
